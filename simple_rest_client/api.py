...
class API:
    def __init__(self, api_root_url=None, params=None, headers=None, cookies=None,
                 timeout=None, append_slash=False, json_encode_body=False):
        self.api_root_url = api_root_url
        self.params = params or {}
        self.headers = headers or {}
        self.coolies = cookies or {}
    ...
    def add_resource(self, api_root_url=None, resource_name=None,
                     resource_class=None, params=None, headers=None, cookies=None,
                     timeout=None, append_slash=False, json_encode_body=False):
        ...
        resource = resource_class(
            ...
            cookies=cookies or self.coolies,
